...
class RouteRegistrationTest extends UnitTestCase
{
    ...
    {
        $this->app['config']->set('services.apple.routes.enabled', false);
    ...
    {
        $this->app['config']->set('services.apple.routes.redirect_route', 'auth/apple/login');
    ...
    {
        $this->app['config']->set('services.apple.routes.callback_route', 'auth/apple/handle');
